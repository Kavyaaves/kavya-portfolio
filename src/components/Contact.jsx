            ...
            {!isFormSubmitted ? (
              <div className="w-full text-start">
                <div>
                  ...
                  <input
                    className={(errors.name === "" || errors.name === null) ? "w-full border-2 focus:ring-3 border-light bg-transparent text-light font-semibold tracking-wide mt-2 p-2 md:p-3 rounded-lg focus:outline-none focus:shadow-outline" : "w-full focus:ring-3 border-light bg-transparent text-light font-semibold tracking-wide mt-2 p-2 md:p-3 rounded-lg focus:outline-none focus:shadow-outline border-2 border-red-500"}
                ...
                <div className="mt-6">
                  ...
                  <input
                    className={(errors.email === "" || errors.email === null) ? "w-full border-2 focus:ring-3 border-light bg-transparent text-light font-semibold tracking-wide mt-2 p-2 md:p-3 rounded-lg focus:outline-none focus:shadow-outline" : "w-full focus:ring-3 border-light bg-transparent text-light font-semibold tracking-wide mt-2 p-2 md:p-3 rounded-lg focus:outline-none focus:shadow-outline border-2 border-red-500"}
                ...
                <div className="mt-8">
                  ...
                  <textarea placeholder="Leave your message here..."
                    ...
                    className={(errors.message === "" || errors.message === null) ? "w-full border-2 focus:ring-3 border-light bg-transparent text-light font-semibold tracking-wide mt-2 p-2 md:p-3 rounded-lg focus:outline-none focus:shadow-outline" : "w-full focus:ring-3 border-light bg-transparent text-light font-semibold tracking-wide mt-2 p-2 md:p-3 rounded-lg focus:outline-none focus:shadow-outline border-2 border-red-500"}
                  ></textarea>
