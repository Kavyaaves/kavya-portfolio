        ...
        <div className="md:h-screen relative -mb-20">
            <div className='max-w-6xl h-100  items-center h-auto lg:h-auto flex-wrap mx-auto lg:my-0'>
                ...
                <Slider {...settings} className='w-4/5  m-auto'>
                    ...
                    <div className="max-w-sm bg-blue-200 float-center m-5 rounded-lg  shadow-md ">
                        <img
                    ...
                    <div class="max-w-sm h-full bg-blue-200 float-center m-5 rounded-lg">
                        <img
                    ...
                    <div class="max-w-sm h-full float-center m-5 bg-blue-200 rounded-lg">
                        <img
