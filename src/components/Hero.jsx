...
const Hero = () => {
    ...
    return (<div className="min-h-screen relative overflow-hidden" >
        ...
        <motion.div>
            ...
            >
                <div className='block lg:hidden rounded-full shadow-xl mx-auto  h-64 w-64 md:h-80 md:w-80'>
                    <motion.img
                ...
                <motion.div className='lg:w-3/5 md:mt-0 mt-16 p-5 m-auto text-center md:text-left'>
                    ...
                    <motion.h1 className="text-3xl md:text-4xl font-mono" transition={{ type: "spring", damping: 25, stiffness: 500, duration: 1 }}>Software Engineer</motion.h1>
                    <h1 className="text-3xl md:text-4xl font-mono">Full Stack Developer</h1>
                    <h1 className="text-3xl md:text-4xl font-mono pb-6 md:pb-12">AI Engineer</h1>
                    <div className="py-6">
                        <motion.a href="/images/Kavya's Resume.pdf" target="_blank" >
                            <span className="border-solid border-2 w-full hover:bg-light hover:text-medium shadow-lg rounded-lg text-lg md:text-xl p-2 md:p-3 cursor-pointer" whileHover="hover"
                    ...
                    <motion.div className="py-6 text-center flex gap-6 md:justify-start justify-center items-center">
                        <div className="flex items-center w-10 h-10">
                            <motion.a href="mailto:kavyamuralioff@gmail.com" target="blank" whileHover="hover"
                                ...
                                <svg className="w-10 h-10 text-light fill-current"
		...
		L0.001,62.603L0,275.001c0.001,8.284,6.716,15,15,15L315.001,290c8.285,0,15-6.716,15-14.999V62.602l-30.001,22L173.871,177.097z"
                        ...
                        <div className="flex items-center w-10 h-10">
                            <motion.a href="https://www.linkedin.com/in/kavya2019" target="blank" whileHover="hover"
                                variants={buttonVariants}>
                                <svg
                                    className="w-10 h-10 text-light fill-current"
                        ...
                        <div className="flex w-10 h-10">
                            <motion.a href="https://www.github.com/kavyaaves" target="blank" whileHover="hover"
                                variants={buttonVariants}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-light fill-current" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg>
                            </motion.a>
                        </div>
                    </motion.div>
                </motion.div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="hidden lg:grid">
            <path fill="#f5f5f4" fillOpacity="1" d="M0,64L80,96C160,128,320,192,480,197.3C640,203,800,149,960,128C1120,107,1280,117,1360,122.7L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
    </div >
    )
}
