...
const ImageSlider = ({ slidesToShow = 3 }) => {
    ...
    let animationProps = {
        initial: { rotateY: -180 },
        animate: { rotateY: 180, transition: { duration: 0.5 } },
                ...
                <motion.div className=" cursor-pointer max-w-lg m-auto bg-blue-200 float-center rounded-lg shadow-md">
                    ...
                    <div class="flip-container rounded-t-lg w-100 h-100">
                        ...
                        <div className={0 === imageIndex ? "flex gap-5 hover-content items-center justify-center m-auto" : "hidden"} >
                            ...
                            <a href="https://bakthavachalam-babu.com" target="_blank" className="text-center items-center justify-center">
                ...
                <div class="max-w-lg h-full bg-blue-200 m-auto float-center rounded-lg">
                    <div class="flip-container w-100 h-100">
                        ...
                        <div className={1 === imageIndex ? "flex gap-5 hover-content items-center justify-center m-auto" : "hidden"} >
                            {/* <div className="text-center items-center justify-center"> */}
                            <a href="https://track-covid19-charts.netlify.app/" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Demo
                                </span>
                            </a>
                            <a href="https://github.com/Kavyaaves/Covid-19__Tracker" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Source Code
                                </span>
                            </a>
                ...
                <div class="max-w-lg bg-blue-200 rounded-lg">
                    ...
                    <div class="flip-container rounded-t-lg w-100 h-100">
                        ...
                        <div className={2 === imageIndex ? "flex gap-5 hover-content items-center justify-center m-auto" : "hidden"} >
                            {/* <div className="text-center items-center justify-center"> */}
                            <a href="https://kavyaaves.github.io/gallery-gram/" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Demo
                                </span>
                            </a>
                            <a href="https://github.com/Kavyaaves/gallery-gram" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Source  Code
                                </span>
                            </a>
                ...
                <div class="max-w-lg h-full bg-blue-200 float-center rounded-lg">
                    <div class="flip-container rounded-t-lg w-100 h-100">
                        ...
                        <div className={3 === imageIndex ? "flex gap-5 hover-content items-center justify-center m-auto" : "hidden"} >
                            {/* <div className="text-center items-center justify-center"> */}
                            <a href="https://kavyaaves.github.io/to-do_redux/" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Demo
                                </span>
                            </a>
                            <a href="https://github.com/Kavyaaves/to-do_redux" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Source  Code
                                </span>
                            </a>
                ...
                <div class="max-w-lg h-full bg-blue-200 float-center rounded-lg">
                    <div class="flip-container rounded-t-lg w-100 h-100">
                        ...
                        <div className={4 === imageIndex ? "flex gap-5 hover-content items-center justify-center m-auto" : "hidden"} >
                            {/* <div className="text-center items-center justify-center"> */}
                            <a href="https://kavyaaves.github.io/To-Do-List/" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Demo
                                </span>
                            </a>
                            <a href="https://github.com/Kavyaaves/To-Do-List" target="_blank" className="text-center items-center justify-center">
                                <span className="border-solid border-2 w-full px-4 hover:bg-blue-100 hover:text-gray-700 shadow-lg rounded-lg text-md md:text-md p-1 md:py-2 cursor-pointer">
                                    Source  Code
                                </span>
                            </a>
