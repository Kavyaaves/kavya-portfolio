...
const AllScreens = () => {
    ...
    return (
        <motion.div animate className="sticky bg-dark backdrop-opacity-10 cursor-pointer max-w-md flex gap-5 items-center justify-center bottom-5 md:p-3 p-1 m-auto  border-2 rounded-full bg-opacity-60 backdrop-filter backdrop-blur-sm">
            <AnimateSharedLayout>
                <motion.div onClick={() => scrollTo("")} whileHover="hover" className={hover == "home" ? "flex text-center items-center rounded-full p-2 px-3 bg-blue-200" : "flex p-2 text-center items-center"} onHoverStart={e => setHover("home")} onHoverEnd={e => setHover("")}>
                ...
                <motion.div onClick={() => scrollTo("work")} whileHover="hover" className={hover == "work" ? "flex text-center items-center rounded-full p-2 px-3 bg-blue-200" : "flex p-2 text-center items-center"} onHoverStart={e => setHover("work")} onHoverEnd={e => setHover("")}>
                    {/* <motion.img
                            className="fill-svg"
                            layout
                ...
                <motion.div whileHover="hover" onClick={() => scrollTo("projects")} className={hover == "project" ? "flex text-center items-center rounded-full p-2 px-3 bg-blue-200" : "flex p-2 text-center items-center"} onHoverStart={e => setHover("project")} onHoverEnd={e => setHover("")}>
                    <motion.div className="items-center justify-center"
                        layout
                        transition={{ duration: 0.3 }}
                    >
